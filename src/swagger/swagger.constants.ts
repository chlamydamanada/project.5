export enum SwaggerConstants {
  ...
  //quizGame
  connection = 'Connect current user to existing random pending pair or create new pair which will be waiting second player',
  connectionOk = 'Returns started existing pair with status "Active" or new pair with status "PendingSecondPlayer"',
  connectionForbidden = 'If current user is already participating in active pair. If user try connect to game twice',
  questionsOfGame = 'Questions should be null until second player joins the game',
  pairCreatedDate = 'Date the first player joined the game',
  startGameDate = 'Date should be null until second player joins the game',
  finishGameDate = 'Date should be null until both players answer all questions of the game',
  secondPlayerProgress = 'This field should be null until second player joins the game',
  getCurrentGame = 'Returns current unfinished user game',
  getCurrentGameOk = 'Returns current pair in which current user is taking part(status of game: "Active" or "PendingSecondPlayer")',
  answer = 'Send answer for next not answered question in active pair',
  answerOk = 'Returns answer result',
  answerForbidden = 'If current user is not inside active pair or user is in active pair but has already answered to all questions',
  gameById = 'Returns game by id only for users who take part in the game',
  gameByIdForbidden = 'If current user tries to get pair in which user is not participant',
}
