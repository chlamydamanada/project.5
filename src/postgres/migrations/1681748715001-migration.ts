...
export class migration1681748715001 implements MigrationInterface {
    name = 'migration1681748715001'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "email_confirmation_info" ("userId" uuid NOT NULL, "confirmationCode" uuid NOT NULL DEFAULT uuid_generate_v4(), "expirationDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "isConfirmed" boolean NOT NULL DEFAULT false, CONSTRAINT "REL_f6f5a164820c2b6020e3352dde" UNIQUE ("userId"), CONSTRAINT "PK_f6f5a164820c2b6020e3352dde1" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE TABLE "password_recovery_info" ("userId" uuid NOT NULL, "recoveryCode" character varying NOT NULL, "expirationDate" TIMESTAMP NOT NULL, CONSTRAINT "REL_e41a883301d05dddf1e42a8713" UNIQUE ("userId"), CONSTRAINT "PK_e41a883301d05dddf1e42a87132" PRIMARY KEY ("userId"))`);
        await queryRunner.query(`CREATE TABLE "ban_info" ("userId" uuid NOT NULL, "isBanned" boolean NOT NULL DEFAULT false, "banDate" character varying, "banReason" character varying, CONSTRAINT "REL_a7b316fecc756363a039a12354" UNIQUE ("userId"), CONSTRAINT "PK_a7b316fecc756363a039a123545" PRIMARY KEY ("userId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "blog_ban_info" ("blogId" uuid NOT NULL, "isBanned" boolean NOT NULL DEFAULT false, "banDate" character varying, CONSTRAINT "REL_5368730149fe844c998658e393" UNIQUE ("blogId"), CONSTRAINT "PK_5368730149fe844c998658e3934" PRIMARY KEY ("blogId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "game" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "status" "public"."game_status_enum" NOT NULL DEFAULT 'PendingSecondPlayer', "pairCreatedDate" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "startGameDate" TIMESTAMP WITH TIME ZONE, "finishGameDate" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_352a30652cd352f552fef73dec5" PRIMARY KEY ("id"))`);
